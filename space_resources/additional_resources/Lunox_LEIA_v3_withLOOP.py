...
class ChemicalParcel:
    ...
    #global variables
    # percentate: cost kWh/kWh dissipated (based on ISS calculation in excel)
    ...
    def transportation(self):
        ...
        Transport_EnerCost_kWh_per_InputRegol_kg = self.regolith_distance * \
            self.TransCostkWh_per_m
    ...
    def beneficiation(self):
        ...
        self.otherminerals_mass = self.otherminerals_mass * \
            0.44  # amount of gangue in target bins
        self.ilmenite_mass = self.ilmenite_mass * \
            0.75  # amount of gangue in target bins
    ...
    def carbothermalreactor(self):
        ...
        self.step = 4
        # kWh/kg regolith extracted
        # hardcoded based on excel calculations
        Carbo_EnerCost_kWh_per_InputRegol_kg = 0.25
        ...
        self.ilmenite_mols = self.ilmenite_mass / 0.157
    ...
    def sabatierreactor(self):
        ...
        Sabat_Cooling_Cost_per_molCO2 = Sabat_HeatProduced_kWh_per_molCO2 * \
            self.EnergyCost_HeatDissipation
        # pumping coolant cost based on ISS calculations
        Sabat_EnerCost_kWh_per_InputCO2_mol = Sabat_Cooling_Cost_per_molCO2
    ...
    def electrolyzer(self):
        ...
        self.step = 6
        # kWh/kg regolith extracted
        Electro_EnerCost_kWh_per_InputH2O_mol = 770 / \
            3600  # based on efficiency parapmeter 70%
...
for ilmenite_iterations in np.arange(0.01, 0.50, 0.01):
    ...
    # distance in meters of center of regoltih voxel from reactor hopper
    regolith_distance = 10
    regolith_depth = 0.01  # max depth of this regolith voxel

    parcel1 = ChemicalParcel(
        regolith_mass, ilmenite_concentration, regolith_distance, regolith_depth)
